...
esM.add(
    fn.Conversion(
        ...
        bigM =600  # Maximalbedarf Raumwärme pro Stunde sind 2858 kWh
...
esM.add(
    fn.Conversion(
        ...
        capacityMax=600,           # thermische Nennleistung
        interestRate=0.05,
        investPerCapacity=100,  # 100 €/kWh Frauenhofer, bei halber installierter Leistung 50 €/kWh
